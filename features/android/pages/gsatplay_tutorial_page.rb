...
class GsatPlayTutorialPage < Calabash::ABase
  ...
  def assert_first_page_content
    sleep(1)
    first = GSATPLAY_TUTORIAL_TEXTS[:first_page]
  ...
  def assert_second_page_content
    sleep(1)
    second = GSATPLAY_TUTORIAL_TEXTS[:second_page]
  ...
  def assert_third_page_content
    sleep(1)
    third = GSATPLAY_TUTORIAL_TEXTS[:third_page]
  ...
  def assert_fourth_page_content
    sleep(1)
    fourth = GSATPLAY_TUTORIAL_TEXTS[:fourth_page]
